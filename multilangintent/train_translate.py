...
2. Train a classifier on translated English text
"""
...
def train_english_classifier(train_df, test_df):
    """Train DistilBERT classifier on translated English text."""
    print("\n" + "="*60)
    print("Training English classifier on translated text")
    print("="*60)
...
def main():
    print("="*60)
    print("TRANSLATION-BASED INTENT CLASSIFICATION (NLLB)")
    print("="*60)
    ...
    # Train classifier
    print("\n" + "="*60)
    print("STEP 3: TRAIN ENGLISH CLASSIFIER")
    print("="*60)
    pred_labels = train_english_classifier(train_translated, test_translated)
    ...
    print("\n" + "="*60)
    print("DONE!")
    print(f"Submission saved to: {OUTPUT_DIR / 'submission_translated.csv'}")
