#!/usr/bin/env python
"""Solution for EEG seizure classification challenge.

Simple ensemble of RF + XGBoost with threshold tuning.
"""
import numpy as np
import pandas as pd
...
def cross_validate(X, y, n_splits=5):
    """Run stratified cross-validation with RF+XGB ensemble."""
    ...
    for fold, (train_idx, val_idx) in enumerate(cv.split(X, y)):
        ...
        # Two models with regularization
...
def main():
    ...
    print("\nCross-validation with RF+XGB ensemble...")
